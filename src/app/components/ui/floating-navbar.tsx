...
import styles from "@/app/components/ui/FloatingNav.module.css"; // Create this file for custom styles
    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <Link href="/login" passHref>
          <button className={cn(
            "border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white px-4 py-2 rounded-full transition-all duration-200 hover:bg-primary hover:text-white",
            styles.loginButton
          )}>
